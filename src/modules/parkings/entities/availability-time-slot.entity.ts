import {
  ...
  export class AvailabilityTimeSlot {
    ...
    @ManyToOne(() => AvailabilitySchedule, schedule => schedule.timeSlots, { onDelete: 'CASCADE' })
    ...
    @ManyToOne(() => AvailabilityException, exception => exception.timeSlots, { onDelete: 'CASCADE', nullable: true })
