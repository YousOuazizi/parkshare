...
export class GeoService {
  ...
  constructor(private configService: ConfigService) {
    this.hereApiKey = this.configService.get<string>('HERE_API_KEY') || 'demo-key';
  }
  ...
  async findNearbyParkingSpots(lat: number, lng: number, radius: number): Promise<NearbyPlace[]> {
    try {
      ...
      this.logger.error(`Error finding nearby parking spots: ${error.message}`, error.stack);
